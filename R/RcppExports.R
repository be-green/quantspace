...
qr_drop_colinear_columns <- function(X) {
    .Call(`_quantspace_qr_drop_colinear_columns`, X)
}

sparse_qr_drop_colinear_columns <- function(X) {
    .Call(`_quantspace_sparse_qr_drop_colinear_columns`, X)
}
